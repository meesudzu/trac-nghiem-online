...
Luư ý: Hiện tại chưa thật sự là MVC, Controller ở đây chỉ đóng vai trò đưa yêu cầu và dữ liệu qua lại giữa View và Model, View vẫn là thành phần xử lý giữ liệu nhận từ Model sau khi qua Controller.Mình sẽ cập nhật lại trong phiên bản sau.
