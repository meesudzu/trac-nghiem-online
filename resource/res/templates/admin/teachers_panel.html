<div class="title-content">
    <span class="title">Quản Lý Thông Tin Giáo Viên</span>
...
<div class="block-content overflow scrollbar">
    <div class="content">
        ...
        <table class="centered striped responsive-table" id="table_teachers">
            <thead>
                <tr>
                    <th class="">
            ...
            <tbody class="scrollbar" id="list_teachers">
            </tbody>
        </table>
    </div>
    <div class="content fadeRight">
        <div class="row">
            <div class="col s12">
                <ul class="tabs">
                    <li class="tab col s6"><a href="#add_normal" class="active" style="color: #02796e; font-weight: bold;">Thêm Giáo Viên</a></li>
            ...
            <div id="add_normal" class="col s12">
                <form action="" method="POST" role="form" id="add_teacher_form">
                    ...
                    <div class="col l12">
                        <button type="submit" class="btn" id="add_teacher" name="add-teacher">Thêm</button>
                    </div>
                </form>
            </div>
            <div id="_add_via_file" class="col s12">
                <span class="title">Tải File Mẫu: <a href="res/files/mau-them-danh-sach-giao-vien.xlsx">TẠI ĐÂY</a></span><br />
