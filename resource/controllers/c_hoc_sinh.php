...
class C_Hoc_Sinh extends Controller
{
   ...
   private $diem = array();
    ...
    public function showHeadLeft()
    {
        ...
        $hoc_sinh->showHeadLeft($this->info,$this->diem);
    }
   ...
   public function doEx($unit)
   {
       ...
       $this->loadView("hoc_sinh");
        ...
        $hoc_sinh->doEx($unit,$cau_hoi,$this->diem);
   }
   ...
   public function sendEx()
   {
        ...
        $diem = $hoc_sinh->sendEx($unit,$ts_ch,$id_cauhoi,$cau_hoi,$da_cauhoi);
