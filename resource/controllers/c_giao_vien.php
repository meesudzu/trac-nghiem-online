...
class C_Giao_Vien extends Controller
{
    ...
    public function showHeadLeft()
    {
        ...
        $giao_vien = new V_Giao_Vien();
        $giao_vien->showHeadLeft($this->info,$this->dsl);
    }
    ...
    public function sendNotify()
    {
        $this->loadView("giao_vien");
        $giao_vien = new V_Giao_Vien();
        $giao_vien->sendNotify($this->getTBHS());
    ...
    public function reNotify()
    {
         $this->loadView("giao_vien");
        $giao_vien = new V_Giao_Vien();
        $giao_vien->reNotify($this->getTBGV());
    }
    ...
    public function showDetails($id_lop)
    {
       ...
       //mảng lưu tên học sin theo id_hs 
        ...
        $this->loadView("giao_vien");
        $giao_vien = new V_Giao_Vien();
        $giao_vien->showDetails($id_lop,$dsl,$dsTenHS,$getCTL);
    }
}
?>